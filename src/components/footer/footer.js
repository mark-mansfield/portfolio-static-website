    ...
    return (
      <div className={styles.footer}>
        <section className={styles.section}>
          <h2>Contact Us</h2>
          <h3>Address</h3>
          106 Curlewis Street &bull; Bondi Beach, &bull; NSW 2026
          <h3>Phone</h3>
          <a
            href="tel:0291301566"
            id="callnowbutton"
        ...
        <section className={styles.section}>
          ...
          <button
            id="launch-newsletter-signup"
            aria-label="launch newsletter sign up"
            className="form-button-accent"
            onClick={this.showModal.bind(this)}
          >
            newsletter
        ...
        <section className={styles.section}>
          <ul>
            <li className={styles.bottom_margin}>
              <a
              ...
              >
                ...
                >
                  ...
                  <g
                    ...
                    strokeWidth="1"
                  >
                    <g fill="dodgerBlue" id="Facebook-1">
                      <path
